...
public class SingleBuyActivity extends AppCompatActivity {
                    ...
                    if (data.hasExtra(PHConstants.INTENT_EXTRA_RESULT)) {
                        ...
                        if (serializable instanceof PHResponse) {
                            ...
                            if (response.isSuccess()) {
                                ...
                                Intent invoiceIntent = new Intent(this, SingleInvoiceActivity.class);
                                ...
                                invoiceIntent.putExtra("title", title);
                                invoiceIntent.putExtra("qty", intentQty);
                                invoiceIntent.putExtra("price", price);
                                invoiceIntent.putExtra("total", formattedTotal);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intentQty = intent.getIntExtra("qty", 1);
        ...
        double totalAmount = intentPrice * intentQty;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(fname)) {
                    CustomToast.show(SingleBuyActivity.this, "Please enter the First Name", R.drawable.error);
                } else if (TextUtils.isEmpty(lname)) {
                    CustomToast.show(SingleBuyActivity.this, "Please enter the Last Name", R.drawable.error);
                } else if (TextUtils.isEmpty(mobile)) {
                    CustomToast.show(SingleBuyActivity.this, "Please enter the Mobile", R.drawable.error);
                } else if (TextUtils.isEmpty(line1)) {
                    CustomToast.show(SingleBuyActivity.this, "Please enter the Address Line 1", R.drawable.error);
                } else if (TextUtils.isEmpty(line2)) {
                    CustomToast.show(SingleBuyActivity.this, "Please enter the Address Line 2", R.drawable.error);
                } else if (TextUtils.isEmpty(city)) {
                    CustomToast.show(SingleBuyActivity.this, "Please enter the City", R.drawable.error);
                } else if (TextUtils.isEmpty(postal)) {
                    CustomToast.show(SingleBuyActivity.this, "Please enter the Postal Code", R.drawable.error);
                } else {
